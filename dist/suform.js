...
(function (w, factory) {
	...
	var suformClass = function () {
		//构造
		function suformClass() {
			_classCallCheck(this, suformClass);

			this.init();
		}

		_createClass(suformClass, [{
			key: "init",
			value: function init() {
			...
			key: "renderRadio",
			value: function renderRadio(dom) {
				var _this = this;
			...
			key: "renderCheckBox",
			value: function renderCheckBox(dom) {
				var _this = this;
			...
			key: "renderSelect",
			value: function renderSelect(dom) {
				var _this = this;
				...
				var itemBoxDom = $('<div />').addClass('suform-item-box').attr({ 'data-type': 'select' }).css({ width: computedStyle.width, border: computedStyle.border, font: computedStyle.font, boxSizing: computedStyle.boxSizing });
				...
				$(dom).find("option").each(function (i) {
					var itemDom = $('<div />').text($(this).text()).addClass('suform-item').attr({ 'data-type': 'select', 'index': i });
